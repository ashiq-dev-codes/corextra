...
A draggable bubble opens the panel. Network, Logs, and Info sit directly on the tab bar; Performance and App Size — used less often — live behind a **More** button:
