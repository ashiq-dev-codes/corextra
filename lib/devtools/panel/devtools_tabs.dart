...
/// Info — shared by the full-screen `DevToolsPanel` and the floating
/// `DevToolsFloatingWindow`. Everything except each surface's own
/// header lives here, so both show identical, fully-featured content;
/// only the window they're framed in differs.
